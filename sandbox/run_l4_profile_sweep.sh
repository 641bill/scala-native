...
platform=$(uname -s)
default_yak_text_input="7z:${parent_dir}/cache/benchmark-data/yak/stackexchange/askubuntu.com.7z!Posts.xml"
default_loghub_hdfs_input="tar.gz:${parent_dir}/cache/benchmark-data/loghub/HDFS_1.tar.gz!HDFS.log"
default_loghub_windows_input="tar.gz:${parent_dir}/cache/benchmark-data/loghub/Windows.tar.gz!Windows.log"
default_loghub_spark_inputs="tar.gz:${parent_dir}/cache/benchmark-data/loghub/Spark.tar.gz!application_1485248649253_0132/container_1485248649253_0132_01_000032.log,tar.gz:${parent_dir}/cache/benchmark-data/loghub/Spark.tar.gz!application_1485248649253_0132/container_1485248649253_0132_01_000006.log,tar.gz:${parent_dir}/cache/benchmark-data/loghub/Spark.tar.gz!application_1485248649253_0132/container_1485248649253_0132_01_000057.log"
default_theodolite_power_input="zip:${parent_dir}/cache/benchmark-data/theodolite/real-power/household_power_consumption.zip!household_power_consumption.txt"
...
case_config() {
  ...
  case "${case_name}" in
    ...
    dspbench-fraud-q2-checked-scoped)
      ...
      env_spec="RIFT_FINAL_CLEAN=1 DSPBENCH_INPUT_MODE=${RIFT_PROFILE_DSPBENCH_INPUT_MODE:-file-backed} DSPBENCH_INPUT=${RIFT_PROFILE_DSPBENCH_INPUT:-${default_dspbench_fraud_input}} DSPBENCH_EVENTS=${RIFT_PROFILE_DSPBENCH_EVENTS:-5000000} DSPBENCH_BENCHMARK_RUNS=1 DSPBENCH_WARMUPS=0 SAFEZONE_ROOTS_MODE=1 SAFEZONE_PAGE_SIZE=32768"
      ;;
    dspbench-fraud-q2-heap)
      main_class="DSPBenchRegionMatrix"
    ...
    loghub-hdfs-stream-topk-checked)
      ...
      env_spec="RIFT_FINAL_CLEAN=1 LOGHUB_TOP_INPUT_MODE=streaming-file LOGHUB_TOP_INPUT=${RIFT_PROFILE_LOGHUB_HDFS_INPUT:-${default_loghub_hdfs_input}} LOGHUB_TOP_LINES=${RIFT_PROFILE_LOGHUB_LINES:-5000000} LOGHUB_TOP_LINES_PER_EPOCH=${RIFT_PROFILE_LOGHUB_LINES_PER_EPOCH:-100000} LOGHUB_TOP_BENCHMARK_RUNS=1 LOGHUB_TOP_WARMUPS=0 SAFEZONE_ROOTS_MODE=1 SAFEZONE_PAGE_SIZE=32768"
      ;;
    loghub-hdfs-stream-topk-heap)
      main_class="LogHubTopTemplatesMatrix"
      args="heap-retained-drop-anchor"
      env_spec="RIFT_FINAL_CLEAN=1 LOGHUB_TOP_INPUT_MODE=streaming-file LOGHUB_TOP_INPUT=${RIFT_PROFILE_LOGHUB_HDFS_INPUT:-${default_loghub_hdfs_input}} LOGHUB_TOP_LINES=${RIFT_PROFILE_LOGHUB_LINES:-5000000} LOGHUB_TOP_LINES_PER_EPOCH=${RIFT_PROFILE_LOGHUB_LINES_PER_EPOCH:-100000} LOGHUB_TOP_BENCHMARK_RUNS=1 LOGHUB_TOP_WARMUPS=0"
      ;;
    yak-topwordreal-checked-scoped)
      main_class="YakRegionMatrix"
      args="checked-epoch-scoped topwordreal"
      env_spec="RIFT_FINAL_CLEAN=1 YAK_TEXT_INPUT=${RIFT_PROFILE_YAK_TEXT_INPUT:-${default_yak_text_input}} YAK_TEXT_INPUT_TOKENS=${RIFT_PROFILE_YAK_TEXT_INPUT_TOKENS:-20000000} YAK_TEXT_TOKENS_PER_EPOCH=${RIFT_PROFILE_YAK_TEXT_TOKENS_PER_EPOCH:-100000} YAK_BENCHMARK_RUNS=1 YAK_WARMUPS=0 SAFEZONE_ROOTS_MODE=1 SAFEZONE_PAGE_SIZE=32768"
      ;;
    yak-topwordreal-topk-scoped)
      main_class="YakRegionMatrix"
    ...
    yak-topwordreal-heap)
      ...
      env_spec="RIFT_FINAL_CLEAN=1 YAK_TEXT_INPUT=${RIFT_PROFILE_YAK_TEXT_INPUT:-${default_yak_text_input}} YAK_TEXT_INPUT_TOKENS=${RIFT_PROFILE_YAK_TEXT_INPUT_TOKENS:-20000000} YAK_TEXT_TOKENS_PER_EPOCH=${RIFT_PROFILE_YAK_TEXT_TOKENS_PER_EPOCH:-100000} YAK_BENCHMARK_RUNS=1 YAK_WARMUPS=0"
      ;;
    yak-topwordreal-heap-topk)
      main_class="YakRegionMatrix"
    ...
    loghub-spark-topk-checked)
      main_class="LogHubTopTemplatesMatrix"
      args="checked-scoped-epoch-topk-retained-no-traverse"
      env_spec="RIFT_FINAL_CLEAN=1 LOGHUB_TOP_INPUT_MODE=file-backed LOGHUB_TOP_INPUTS=${RIFT_PROFILE_LOGHUB_SPARK_INPUTS:-${default_loghub_spark_inputs}} LOGHUB_TOP_LINES=${RIFT_PROFILE_LOGHUB_SPARK_LINES:-2000000} LOGHUB_TOP_LINES_PER_EPOCH=${RIFT_PROFILE_LOGHUB_LINES_PER_EPOCH:-100000} LOGHUB_TOP_BENCHMARK_RUNS=1 LOGHUB_TOP_WARMUPS=0 SAFEZONE_ROOTS_MODE=1 SAFEZONE_PAGE_SIZE=32768"
      ;;
    loghub-spark-topk-heap)
      main_class="LogHubTopTemplatesMatrix"
      args="heap-retained-drop-anchor"
      env_spec="RIFT_FINAL_CLEAN=1 LOGHUB_TOP_INPUT_MODE=file-backed LOGHUB_TOP_INPUTS=${RIFT_PROFILE_LOGHUB_SPARK_INPUTS:-${default_loghub_spark_inputs}} LOGHUB_TOP_LINES=${RIFT_PROFILE_LOGHUB_SPARK_LINES:-2000000} LOGHUB_TOP_LINES_PER_EPOCH=${RIFT_PROFILE_LOGHUB_LINES_PER_EPOCH:-100000} LOGHUB_TOP_BENCHMARK_RUNS=1 LOGHUB_TOP_WARMUPS=0"
      ;;
    loghub-windows-topk-checked)
      main_class="LogHubTopTemplatesMatrix"
      args="checked-scoped-epoch-topk-retained-no-traverse"
      env_spec="RIFT_FINAL_CLEAN=1 LOGHUB_TOP_INPUT_MODE=streaming-file LOGHUB_TOP_INPUT=${RIFT_PROFILE_LOGHUB_WINDOWS_INPUT:-${default_loghub_windows_input}} LOGHUB_TOP_LINES=${RIFT_PROFILE_LOGHUB_WINDOWS_LINES:-5000000} LOGHUB_TOP_LINES_PER_EPOCH=${RIFT_PROFILE_LOGHUB_LINES_PER_EPOCH:-100000} LOGHUB_TOP_BENCHMARK_RUNS=1 LOGHUB_TOP_WARMUPS=0 SAFEZONE_ROOTS_MODE=1 SAFEZONE_PAGE_SIZE=32768"
      ;;
    loghub-windows-topk-heap)
      main_class="LogHubTopTemplatesMatrix"
      args="heap-retained-drop-anchor"
    ...
    theodolite-power-q2-checked-scoped)
      ...
      env_spec="RIFT_FINAL_CLEAN=1 THEODOLITE_POWER_INPUT=${RIFT_PROFILE_THEODOLITE_POWER_INPUT:-${default_theodolite_power_input}} THEODOLITE_POWER_RECORDS=${RIFT_PROFILE_THEODOLITE_POWER_RECORDS:-2000000} THEODOLITE_POWER_RECORDS_PER_EPOCH=${RIFT_PROFILE_THEODOLITE_POWER_RECORDS_PER_EPOCH:-25000} THEODOLITE_POWER_BENCHMARK_RUNS=${RIFT_PROFILE_THEODOLITE_POWER_RUNS:-20} THEODOLITE_POWER_WARMUPS=0 SAFEZONE_ROOTS_MODE=1 SAFEZONE_PAGE_SIZE=32768"
      ;;
    theodolite-power-q2-heap)
      main_class="TheodolitePowerRegionMatrix"
