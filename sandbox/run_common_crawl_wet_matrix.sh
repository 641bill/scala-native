...
run_case() {
  ...
  if ! grep -q "^RESULT name=common-crawl-wet-${query}-${binary_mode} " "${run_log}"; then
    ...
    echo "COMMON_CRAWL_WET_RESULT query=${query} mode=${mode} heap_cap=${heap_cap} status=failed exit_status=${command_status} external_real_s=${external_real_s} external_user_s=${external_user_s} external_sys_s=${external_sys_s} max_rss_bytes=${max_rss_bytes}" >&2
  ...
  echo "COMMON_CRAWL_WET_EXTERNAL_RESULT query=${query} mode=${mode} heap_cap=${heap_cap} external_real_s=${external_real_s} external_user_s=${external_user_s} external_sys_s=${external_sys_s} max_rss_bytes=${max_rss_bytes}"
