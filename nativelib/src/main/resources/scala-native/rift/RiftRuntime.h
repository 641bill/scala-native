...
size_t scalanative_rift_stats_alloc_object_total(void);
size_t scalanative_rift_stats_alloc_slow_total(void);
size_t scalanative_rift_stats_alloc_zero_object_total(void);
size_t scalanative_rift_stats_alloc_zero_object_bytes_total(void);
size_t scalanative_rift_stats_alloc_zero_skipped_total(void);
size_t scalanative_rift_stats_alloc_zero_skipped_bytes_total(void);
